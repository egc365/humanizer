<!-- egc365 fork header -->
> **This is the egc365-maintained fork** of [blader/humanizer](https://github.com/blader/humanizer).
>
> **Canonical pattern source**: [egc365/signs-of-ai-writing](https://github.com/egc365/signs-of-ai-writing) — structured, versioned home for the Wikipedia "Signs of AI writing" catalog (seeded using patterns and processing conventions from egc365/base).
>
> The SKILL.md here remains the best ready-to-use Claude/OpenCode implementation.
...
git clone https://github.com/egc365/humanizer.git ~/.claude/skills/humanizer
```
...
git clone https://github.com/egc365/humanizer.git ~/.config/opencode/skills/humanizer
```
...
- [egc365/signs-of-ai-writing](https://github.com/egc365/signs-of-ai-writing) - Canonical structured patterns source
...
*egc365 fork maintained with reference to egc365/base processing conventions and the dedicated signs-of-ai-writing catalog.*
